...
export const Markdown = memo(function Markdown({
  ...
  // In streamdown v1.4, code highlighting is built-in via shikiTheme
  // and mermaid is built-in via mermaidConfig.
  // The enableCode/enableMermaid flags are kept for API compatibility.
  return (
    <Streamdown
