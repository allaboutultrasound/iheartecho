/**
 * Test script: call the AI gateway directly with the QuickFire AI generator prompt
...
const baseURL = `${AI_GATEWAY_URL.replace(/\/+$/, "")}/v1`;
...
console.log("Calling AI gateway at:", baseURL);
console.log("---");
